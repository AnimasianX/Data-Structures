...
void printListForward(LinkedList *list);
void printListReverse(LinkedList *list);

//helper recursive functions to implement traversal 
void printRecForward(Node *);
void printRecReverse(Node *);
///end of functions for recursive printing
...
void menu(){
    ...
    printf("12.Print list forward(recursive)\n");
    printf("13.Print list backwards(recursive\n");
    printf("14.Quit\n");
